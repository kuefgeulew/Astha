...
export default function ReceiptCard({
  ...
  return (
    <section id="qr-receipt" className="relative select-none">
      <div className="overflow-hidden rounded-[24px] ring-1 ring-white/15 shadow-[0_24px_80px_rgba(9,62,115,0.28)] bg-white/10 backdrop-blur-2xl border border-white/20">
        {/* HEADER (glassy gradient) */}
        <div className="relative px-6 pt-6 pb-28 text-white bg-gradient-to-br from-[#0B63B6]/90 via-[#114A92]/90 to-[#093E73]/90">
          {/* soft glow */}
        ...
        <div className="px-4 pb-6 sm:px-6 -mt-10">
          <div className="mx-auto max-w-3xl rounded-2xl bg-white/80 backdrop-blur p-5 shadow-[0_10px_30px_rgba(0,0,0,0.08)] ring-1 ring-black/5">
...
function ActionButton({
  ...
  return (
    <button
      onClick={onClick}
      className="
        inline-flex items-center gap-2 rounded-xl border bg-white/90 px-3.5 py-2
        text-slate-700 ring-1 ring-black/5 shadow-[0_4px_16px_rgba(0,0,0,0.06)]
        hover:bg-white
      "
    >
